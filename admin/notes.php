...
<body>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        $cc = $row['coursecode'];
                        ?>
                        <a href="deletenote.php?id=<?php echo $id ?> & cc=<?php echo $cc ?>" onclick = "return checkdelete()">
                        <span>Delete</span>
                        </a>
                    </td>
                    <td>
                        <a href="updatenote.php?id=<?php echo $id ?>">
                            <span>Update</span>
                        </a>
                    </td>
                </tr>
    ...
    if(isset($_POST["submit"])){
        ...
        if(mysqli_query($conn,$sql)){
            ...
            ?>
            <META HTTP-EQUIV="Refresh" CONTENT ="0; URL= http://localhost/noteapp/admin/notes.php?code=<?php echo $coursecode ?>">
            <?php
        }
        else{
