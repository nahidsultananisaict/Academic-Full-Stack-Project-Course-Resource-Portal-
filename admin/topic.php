...
<body>
    ...
    ?>
        ...
        <li style=" margin-left:40%"><span style="font-size:20px; font-weight:bold">Add Topics</span>
            ...
            <tr class="tr2">
                ...
                <td>
                    <?php
                        ...
                        $cc = $row2['coursecode'];
                    ?>
                    <a href="deletetopic.php?id=<?php echo $id ?> & cc=<?php echo $cc ?>" onclick = "return checkdelete()">
                    <span>Delete</span>
                    </a>                   
                </td>
                <td>
                    <?php
                        ...
                        $to = $row2['topic'];
                    ?>
                    <a href="updatetopic.php?id=<?php echo $id ?> & cc=<?php echo $cc ?> & c=<?php echo $c ?> & chp=<?php echo $chp ?> & to=<?php echo $to ?> & vid=<?php echo $vid ?> & web=<?php echo $web ?>">
                    <span>Update</span>
                    </a>   
                </td>
            </tr>  
