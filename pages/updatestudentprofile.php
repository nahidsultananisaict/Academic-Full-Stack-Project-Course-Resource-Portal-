...
<?php
    ...
    {       
        ...
        if($_FILES["newimage"]["name"] != '')
        {
            ...
            {
                $sql1 = "UPDATE profile SET Name='$name',Username='$username',Roll='$roll',Session='$sesion',Email='$email',PhoneNumber='$phone',Image='$up_image',Batch='$batch' WHERE Id='$id'";
                $data=mysqli_query($conn,$sql1);
                if($data)
                {
                    echo"<script>alert('Image already exists');</script>";
                    ?>
                    <META HTTP-EQUIV="Refresh" CONTENT ="0; URL= http://localhost/noteapp/pages/profile.php">
                    <?php
                }
                else
                {
            ...
            else
            {
                ...
                $sql = "UPDATE profile SET Name='$name',Username='$username',Roll='$roll',Session='$sesion',Email='$email',PhoneNumber='$phone',Image='$up_image',Batch='$batch' WHERE Id='$id'";
