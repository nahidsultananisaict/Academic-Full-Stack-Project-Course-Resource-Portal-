...
<body>
    <div class="main">
        <div class="first">
            <ul>
                <li style=" margin-left:17%"><span class="span">Add Slides</span>
                <!-- invisible -->
                <?php 
                ...
                <li style=" margin-left:12%"><span class="span">Add Books</span>
                <!-- invisible -->
                <?php 
                        $username=$_SESSION["username"];
                        $query = $conn->query("SELECT * FROM request WHERE username='$username'");
               ...
               <?php
                ...
                <tr>
                    ...
                    <td>
                        ...
                        $id=$row['id'];
                        ?>
                        <a href="updateslide.php?id=<?php echo $id ?>"><?php } } ?>
               ...
               <?php
                ...
                <tr>
                    ...
                    <td>
                        ...
                        $id=$row['id'];
                        ?>
                        <a href="updatebook.php?id=<?php echo $id ?>"><?php } } ?>
                            <span class="span">Update</span>
                        </a>
                    </td>
                </tr>
