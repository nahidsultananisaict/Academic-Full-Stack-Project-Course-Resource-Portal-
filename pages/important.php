...
<body>
    ...
    <div class="main">
        ...
        <ul>
            ...
            <li style="margin-left:20%"><h3><span class="span">Add Topics</span></h3>
            <!-- invisible -->
            <?php 
                        ...
                        while($row2 = $result2->fetch_assoc()){   ?>                        
                            <tr>
                                ...
                                <?php if($approval == 1){ 
                                    ...
                                    $cc=$row2['coursecode'];
                                ?>
                                <a href="updateimp.php?id=<?php echo $id ?> & cc=<?php echo $cc ?> & c=<?php echo $c ?> & chp=<?php echo $chp ?> & to=<?php echo $to ?>"> <?php } }?>
